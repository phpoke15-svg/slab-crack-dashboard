...
const description =
  "CollecTools pricing: Premium from $4.99/mo for full SlabCrack and ad-free browsing, Pro from $9.99/mo for Pokemon Center PokeWatch. 7-day free trial."
        ...
        data={{
          ...
          itemListElement: [
            ...
            },
            {
              ...
              price: "9.99",
              priceCurrency: "USD",
              description: "Premium plus Pokemon Center PokeWatch",
            },
          ],
        }}
      />
