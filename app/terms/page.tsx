  ...
  return (
    ...
    >
      ...
      <LegalSection title="9. Paid subscriptions (Premium & Pro)">
        ...
        <ul>
          <li>
            <strong className="text-foreground">Premium</strong> — top 100 SlabCrack + SlabLab
            boards and ad-free access to {LEGAL_PRODUCT_NAME} tools ($4.99/mo or $39.99/yr).
          </li>
          <li>
        ...
        <p>
          The free tier includes 10 mid-ranked SlabCrack + SlabLab cards, full CardLounge,
          PokeMatch, and Feedback, with ads, as described on the pricing page.
        </p>
        <p>
