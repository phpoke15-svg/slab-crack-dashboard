...
export default function PrivacyPage() {
  return (
    <LegalPageShell
      ...
      description={`This policy describes how ${LEGAL_SITE_NAME} ("we", "us") handles information when you use our website and tools, including ${LEGAL_PRODUCT_NAME}.`}
    >
      <LegalSection title="1. Who we are">
        <p>
          {LEGAL_SITE_NAME} operates collector tools at{" "}
          <a href={LEGAL_SITE_URL}>{LEGAL_SITE_URL}</a>, including {LEGAL_PRODUCT_NAME} for
          organizing binders and coordinating trades with other collectors.
        </p>
        <p>
