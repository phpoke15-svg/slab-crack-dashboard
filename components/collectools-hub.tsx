      ...
      <header className="mb-10 flex items-start justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-6 max-w-xl text-sm leading-relaxed text-muted-foreground">
            Pick a tool to get started. SlabCrack finds arbitrage, Restocks auto-tracks Walmart sealed
            stock, PokeMatch keeps your collection organized for swaps, and Queue Watch alerts you when
