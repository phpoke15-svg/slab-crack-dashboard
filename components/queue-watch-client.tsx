            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                ...
                {entitlements.plan === "premium"
                  ? " You're on Premium (top 100 boards, ad-free) — upgrade to Pro for scanner, search, and PokeWatch."
                  : " Premium ($4.99/mo) adds top 100 SlabCrack + SlabLab boards ad-free. Pro unlocks scanner, search, and PokeWatch."}
              </p>
              {error ? (
                <p
                  role="alert"
