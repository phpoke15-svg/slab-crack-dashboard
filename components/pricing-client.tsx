...
function HeroVisual() {
  return (
    <div className="relative mx-auto w-full max-w-md lg:max-w-none">
      <div className="relative rounded-2xl border border-border bg-card/80 p-3 shadow-2xl shadow-black/40 sm:p-4">
        <div className="mb-3 flex items-center gap-1.5">
          <span className="size-2 rounded-full bg-muted-foreground/40" />
          <span className="size-2 rounded-full bg-muted-foreground/40" />
          <span className="size-2 rounded-full bg-muted-foreground/40" />
          <span className="ml-2 truncate rounded-md bg-secondary/80 px-2 py-0.5 font-mono text-[10px] text-muted-foreground">
            pokemoncenter.com
          </span>
        </div>
      ...
      <div className="absolute -bottom-4 -right-1 w-[11.5rem] rounded-[1.35rem] border border-border bg-card p-2 shadow-xl shadow-black/50 sm:-right-3 sm:w-52">
        <div className="rounded-[1rem] border border-border/70 bg-background px-3 py-3">
          <div className="flex items-start gap-2.5">
            <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-lg bg-primary/15 text-[11px] font-bold text-primary">
              CT
            </span>
            <div className="min-w-0">
              <p className="text-[11px] font-semibold text-foreground">Queue Alert!</p>
