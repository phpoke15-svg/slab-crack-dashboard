...
const ALL_COLLECTOOLS: CollecTool[] = [
  {
    ...
    description:
      "SlabCrack compares raw NM prices against PSA slab quotes so you can spot buy-crack-sell opportunities, collection bargains, and graded vs raw gaps. Starter shows 10 mid-ranked cards; Premium adds the top 100; Pro unlocks the full feed, search, and camera scanner.",
    highlights: [
      ...
      "Pro: camera scan for instant Crack + Lab prices",
    ],
    icon: Layers,
  },
  {
    ...
    description:
      "SlabLab ranks modern Pokémon TCG cards by PSA 10 gross spread, graded multiplier, and net ROI after grading cost. Starter shows 10 mid-ranked cards; Premium adds the top 100; Pro unlocks the full board, search, and camera scanner.",
    highlights: [
      ...
      "Pro: camera scan for instant Crack + Lab ROI",
    ],
    icon: Ratio,
  },
  {
